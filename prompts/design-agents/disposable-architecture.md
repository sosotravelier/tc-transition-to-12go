...
### Required
1. `prompts/context/system-context.md` -- full system context (read Key Constraints carefully)
...
5. `design/decision-map.md` -- decisions already made, including D0 (POC-first, deferred)
