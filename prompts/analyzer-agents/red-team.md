...
### Also Read
5. `design/decision-map.md` -- decisions made and open questions
6. `current-state/cross-cutting/authentication.md` -- known hard problem
7. `current-state/integration/12go-api-surface.md` -- the 12go API we depend on
